...
class Search(Tk):
    def __init__(self):
        ...
        self.canvas = Canvas(width=1366, height=768, bg='#9900cc')
        self.canvas.pack()
        self.iconbitmap(r'libico.ico')
        l1 = Label(self, text="Search Student", bg='#db9200', font=("Arial", 20, 'bold')).place(x=290, y=40)
        l = Label(self, text="Search By", bg='#9900cc', fg= 'white', font=("Helvetica", 10, 'bold')).place(x=180, y=100)
        ...
        self.b = Button(self, text="Find", width=8, bg= '#db9200',font=("Arial", 8, 'bold'), command=ge)
        ...
        self.la = Label(self, text="Enter", bg='#9900cc', fg= 'white',
                        font=("Helvetica", 10, 'bold')).place(x=180, y=140)
